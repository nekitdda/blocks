# <img src="src/assets/icons/logo.svg" width="48" align="middle" alt="YouMuz" /> YouMuz (a Yandex Music client)

![License](https://img.shields.io/github/license/DarkPlayOff/YouMuz)
![Release](https://img.shields.io/github/v/release/DarkPlayOff/YouMuz)
![Downloads](https://img.shields.io/github/downloads/DarkPlayOff/YouMuz/total)
![Platform](https://img.shields.io/badge/platform-Windows%20%7C%20Linux%20%7C%20macOS%20%7C%20Android-lightgrey)
[![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/DarkPlayOff/YouMuz)
...
- **Несколько аккаунтов**: как в Telegram — добавление без выхода, переключение в один клик; у каждого аккаунта своя сессия, медиатека, история, настройки звука и скачанные треки
- **Интерфейс «Графит»**: тёмная тёплая палитра, шрифты Onest и JetBrains Mono, волновая форма вместо полосы прогресса
